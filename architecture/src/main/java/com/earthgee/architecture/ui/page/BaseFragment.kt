...
abstract class BaseFragment : DataBindingFragment() {
    ...
    protected inline fun <reified T : ViewModel> getFragmentScopeViewModel(): T =
        mViewModelScope.getFragmentScopeViewModel(this, T::class.java)

    protected inline fun <reified T : ViewModel> getActivityScopeViewModel(): T =
        mViewModelScope.getActivityScopeViewModel(mActivity, T::class.java)
